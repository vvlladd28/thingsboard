...
export class MapDataLayerDialogComponent extends DialogComponent<MapDataLayerDialogComponent, MapDataLayerSettings> {
  ...
  constructor(protected store: Store<AppState>,
    ...
    this.dataLayerFormGroup = this.fb.group({
      ...
      createdEntity: this.fb.group({
        enable: [this.settings.createdEntity?.enable, []],
        label: [this.settings.createdEntity?.label ?? '', []],
        icon: [this.settings.createdEntity?.icon ?? '', []],
    ...
    switch (this.dataLayerType) {
      ...
      case 'circles':
        ...
        if (this.dataLayerType === 'polygons') {
          ...
          (this.dataLayerFormGroup.get('createdEntity') as FormGroup)
            .addControl('polygonType', this.fb.control(this.settings.createdEntity?.polygonType ?? 'polygon'))
        } else {
